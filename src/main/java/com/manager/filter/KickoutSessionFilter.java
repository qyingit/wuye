...
import com.manager.common.IStatusMessage;
import com.manager.common.utils.ShiroFilterUtils;
...
public class KickoutSessionFilter extends AccessControlFilter {
    ...
    public static void out(ServletResponse response, ResponseDTO result){
    ...
    private boolean isAjaxResponse(ServletRequest request,
        ...
        if (ShiroFilterUtils.isAjax(request) ) {
            ...
            out(response, ResponseDTO.fail("您已在别处登录，请您修改密码或重新登录"));
        }else{
            // 重定向
